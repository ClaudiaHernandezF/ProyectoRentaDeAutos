...
Public Class ClaseEstados
    ...
    Public Function consultaUnEstado() As Boolean
        ...
        strSQL = "SELECT idEstado, nombreEstado FROM Estados WHERE idEstado =" & FrmCatalogo.TxtIdEstado.Text
        ...
        If xDT.Rows.Count = 1 Then
            ...
            Else
                ...
                FrmCatalogo.TxtNomEstado.Text = CStr(xDT.Rows(0)("nombreEstado"))
            End If
    ...
    Public Function validaCiudades() As Boolean
        ...
        strSQL = "Select * FROM Ciudades " &
               " WHERE idEstado = " & FrmCatalogo.TxtIdEstado.Text
