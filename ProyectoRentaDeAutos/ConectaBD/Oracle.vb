...
Public Class Oracle
    ...
    Public Sub New()
        ...
        ' y contraseña dueño de las tablas, es quien hizo el CREATE TABLE el usuario adminRen es MI USUARIO
        'Donde Data Source=XE   Es el nombre de la Base de Datos
        '          User Id=adminRen Es el nombre del usuario creado por system es el dueño de las tablas
        '          Password=adminRen Es la contraseña del usuario

        cnx = New OracleConnection("Data Source=XE;User Id=adminRen;Password=adminRen;")
